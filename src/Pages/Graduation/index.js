...
export default function Home(){
    ...
    const StyledBadge = styled(Badge)(({ theme }) => ({
        ...
        const {list, wedList, gradList, partyList, setGradList} = useList()
        console.log(list)
    ...
    return(
        <Main>
                ...
                <Box>
                    <AppBar position="static">
                        <Toolbar sx={{display: 'flex', justifyContent: 'flex-end'}}>
                            ...
                            <IconButton onClick={ToWedding}>
                                <StyledBadge badgeContent={wedList.length} color="warning" style={{marginRight: '12px'}}>
                                    <p>Casamento</p>
                                </StyledBadge>
                            </IconButton>
                        </Toolbar>
            ...
            <Container>
                {
                    gradList.map((elt) => <Display item={elt} lista={gradList} set={setGradList}></Display>)
                }
